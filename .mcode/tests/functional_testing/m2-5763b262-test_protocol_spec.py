...
Generated at: 2026-04-29T09:40:03.714518+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    json.loads(r'''[
    {
        ...
        "method": "POST",
        "description": "Register a brand-new user; expect 201 and a serialized user without password_hash.",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
                "username": "alice_register_happy",
                "password": "alice_secure_pw_1"
            }
        },
        "expected_status": 201,
        "setup": null,
    ...
    },
    {
        ...
        "endpoint": "/user/register",
        "method": "POST",
        "description": "Registering with a username that already exists returns 400 with {message: 'User exists'}.",
        "setup": {
            "endpoint": "/user/register",
            "method": "POST",
            "body": {
                "username": "bob_duplicate_user",
                "password": "bob_secure_pw_1"
            },
            "extract_id_from": "id"
        },
        "request_data": {
    ...
    },
    {
        ...
        "endpoint": "/user/register",
        "method": "POST",
        "description": "Registration without the required password field is rejected (binding:required on password).",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
                "username": "charlie_no_password"
            }
        },
        "expected_status": 400,
        "setup": null,
    ...
    },
    {
        ...
        "endpoint": "/user/login",
        "method": "POST",
        "description": "Setup registers a user; logging in with the matching credentials returns 200 with both access_token and refresh_token.",
        "setup": {
            "endpoint": "/user/register",
            "method": "POST",
            "body": {
                "username": "dave_login_happy",
                "password": "dave_secure_pw_1"
            },
            "extract_id_from": "id"
        },
        "request_data": {
    ...
    },
    {
        ...
        "endpoint": "/user/login",
        "method": "POST",
        "description": "Logging in with the right username but the wrong password returns 401 {message: 'Invalid credentials'}.",
        "setup": {
            "endpoint": "/user/register",
            "method": "POST",
            "body": {
                "username": "eve_wrong_pw",
                "password": "eve_correct_pw"
            },
            "extract_id_from": "id"
        },
        "request_data": {
    ...
    {
        "name": "login_user_unknown_username",
        "category": "NOT_FOUND",
        "endpoint": "/user/login",
        "method": "POST",
        "description": "Logging in with a username that does not exist returns 401 (the API does not differentiate to avoid user enumeration).",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
                "username": "ghost_user_does_not_exist_xyz",
                "password": "irrelevant"
            }
        },
        "expected_status": 401,
    ...
    },
    {
        ...
        "method": "POST",
        "description": "Logging out with a valid access token returns 200 and revokes the JTI.",
        "request_data": {
            "path": {},
            "query": {},
            "headers": {
    ...
    {
        "name": "logout_user_missing_token",
        "category": "AUTH",
        "endpoint": "/user/logout",
        "method": "POST",
        "description": "Logging out without an Authorization header is rejected with 401.",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    },
    {
        ...
        "method": "POST",
        "description": "POST /user/refresh with a valid refresh token returns 200 with a new access_token.",
        "request_data": {
            "path": {},
            "query": {},
            "headers": {
    ...
    {
        "name": "refresh_with_access_token_rejected",
        "category": "AUTH",
        "endpoint": "/user/refresh",
        "method": "POST",
        "description": "Sending an access token (wrong token type) to /user/refresh is rejected with 401.",
        "request_data": {
            "path": {},
            "query": {},
            "headers": {
    ...
    {
        "name": "get_user_cross_user_unauthorized",
        "category": "AUTH",
        "endpoint": "/user/{id}",
        "method": "GET",
        "description": "Setup registers a separate user; requesting their record with another user's access token returns 401 (load-then-check ordering).",
        "setup": {
            "endpoint": "/user/register",
            "method": "POST",
            "body": {
                "username": "victim_cross_user_get",
                "password": "victim_pw_1"
            },
            "extract_id_from": "id"
        },
        "request_data": {
    ...
    },
    {
        ...
        "endpoint": "/user/{id}",
        "method": "GET",
        "description": "Requesting a user id that does not exist returns 404 (get_or_404 is checked before ownership).",
        "request_data": {
            "path": {
                "id": 99999999
            },
    ...
    {
        "name": "get_user_missing_token",
        "category": "AUTH",
        "endpoint": "/user/{id}",
        "method": "GET",
        "description": "GET /user/<id> without an Authorization header is rejected with 401 before any DB lookup.",
        "request_data": {
            "path": {
                "id": 1
            },
    ...
    {
        "name": "delete_user_cross_user_unauthorized",
        "category": "AUTH",
        "endpoint": "/user/{id}",
        "method": "DELETE",
        "description": "Setup registers a separate user; attempting to DELETE them with a different user's token returns 401 and the row remains.",
        "setup": {
            "endpoint": "/user/register",
            "method": "POST",
            "body": {
                "username": "victim_cross_user_delete",
                "password": "victim_pw_2"
            },
            "extract_id_from": "id"
        },
        "request_data": {
    ...
    },
    {
        ...
        "endpoint": "/user/{id}",
        "method": "DELETE",
        "description": "DELETE /user/<id> with an id that does not exist returns 404 (get_or_404 ordering).",
        "request_data": {
            "path": {
                "id": 99999998
            },
