...
Generated at: 2026-04-29T09:44:33.594080+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    json.loads(r'''[
    {
        ...
        "endpoint": "/store/",
        "method": "POST",
        "description": "Authenticated user creates a store; expect 201 with id, name, user_id.",
        "request_data": {
            "path": {},
            "query": {},
            "headers": {
    ...
    {
        "name": "create_store_unauthenticated",
        "category": "AUTH",
        "endpoint": "/store/",
        "method": "POST",
        "description": "Reject store creation when JWT is missing.",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/store/s",
        "method": "GET",
        "description": "Authenticated user lists their stores; expect 200 with a JSON array.",
        "request_data": {
            "path": {},
            "query": {},
            "headers": {
    ...
    {
        "name": "list_stores_unauthenticated",
        "category": "AUTH",
        "endpoint": "/store/s",
        "method": "GET",
        "description": "Reject listing stores when JWT is missing.",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    {
        "name": "get_store_by_id_happy_path",
        "category": "HAPPY_PATH",
        "endpoint": "/store/{id}",
        "method": "GET",
        "description": "Create a store, then retrieve it by id; expect 200 with matching name and user_id.",
        "setup": {
            "endpoint": "/store/",
            "method": "POST",
            "headers": {
    ...
    },
    {
        ...
        "endpoint": "/store/{id}",
        "method": "GET",
        "description": "Retrieving a non-existent store returns 404.",
        "request_data": {
            "path": {
                "id": 999999
            },
    ...
    },
    {
        ...
        "endpoint": "/store/{id}",
        "method": "DELETE",
        "description": "Create a store, then delete it; expect 200 and the standard {message:'Deleted'} body.",
        "setup": {
            "endpoint": "/store/",
            "method": "POST",
            "headers": {
    ...
    },
    {
        ...
        "endpoint": "/store/{id}",
        "method": "DELETE",
        "description": "Deleting a non-existent store returns 404.",
        "request_data": {
            "path": {
                "id": 999999
            },
    ...
    },
    {
        ...
        "endpoint": "/item/",
        "method": "POST",
        "description": "Create a store via setup, then create an item in that store; expect 201 with id, name, price, store_id.",
        "setup": {
            "endpoint": "/store/",
            "method": "POST",
            "headers": {
    ...
    },
    {
        ...
        "endpoint": "/item/",
        "method": "POST",
        "description": "Creating an item with a non-existent store_id returns 404.",
        "request_data": {
            "path": {},
            "query": {},
            "headers": {
    ...
    {
        "name": "create_item_unauthenticated",
        "category": "AUTH",
        "endpoint": "/item/",
        "method": "POST",
        "description": "Reject item creation when JWT is missing.",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/item/s",
        "method": "GET",
        "description": "Authenticated user lists items across their stores; expect 200 with a JSON array.",
        "request_data": {
            "path": {},
            "query": {},
            "headers": {
    ...
    {
        "name": "list_items_unauthenticated",
        "category": "AUTH",
        "endpoint": "/item/s",
        "method": "GET",
        "description": "Reject listing items when JWT is missing.",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    },
    {
        ...
        "endpoint": "/item/{id}",
        "method": "GET",
        "description": "Retrieving a non-existent item returns 404.",
        "request_data": {
            "path": {
                "id": 999999
            },
    ...
    },
    {
        ...
        "endpoint": "/item/{id}",
        "method": "PUT",
        "description": "Updating a non-existent item returns 404.",
        "request_data": {
            "path": {
                "id": 999999
            },
    ...
    },
    {
        ...
        "endpoint": "/item/{id}",
        "method": "DELETE",
        "description": "Deleting a non-existent item returns 404.",
        "request_data": {
            "path": {
                "id": 999999
            },
