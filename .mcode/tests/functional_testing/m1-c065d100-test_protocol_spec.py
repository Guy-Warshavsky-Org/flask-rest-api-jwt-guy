...
Generated at: 2026-04-29T09:36:37.398136+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    json.loads(r'''[
    {
        ...
        "expected_status": 200,
        "description": "GET /health/ with the database reachable returns 200 and {status: healthy, database: healthy}, mirroring the Flask probe.",
        "setup": null,
        "cleanup": null
    },
    {
        ...
        "expected_status": 405,
        "description": "POST is not registered for /health/ (only GET is). Gin should respond with 405 Method Not Allowed for the existing path.",
        "setup": null,
        "cleanup": null
    },
    {
        "name": "health_check_unknown_subpath_not_found",
        "category": "NOT_FOUND",
        "endpoint": "/health/does-not-exist",
        "method": "GET",
        "request_data": {
            "path": {},
            "query": {},
        ...
        "expected_status": 404,
        "description": "Only /health/ is mounted under the health group. Any nested unknown path should return 404.",
        "setup": null,
        "cleanup": null
    }
]''')
