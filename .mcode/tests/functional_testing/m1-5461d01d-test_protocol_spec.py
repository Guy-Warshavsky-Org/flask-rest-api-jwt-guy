...
Generated at: 2026-03-01T18:27:10.962982+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    json.loads(r'''[
    {
        ...
        "method": "POST",
        "description": "Register a new user with valid username and password, expect 201 with user data returned",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/user/register",
        "method": "POST",
        "description": "Attempt to register a user with an already-taken username, expect 400 with 'User exists' message",
        "setup": {
            "endpoint": "/user/register",
            "method": "POST",
            "body": {
                "username": "dupuser_reg2",
                "password": "${TEST_PASSWORD}"
            },
            "extract_id_from": "id"
        },
    ...
    },
    {
        ...
        "endpoint": "/user/login",
        "method": "POST",
        "description": "Login with valid credentials, expect 200 with access_token and refresh_token in response",
        "setup": {
            "endpoint": "/user/register",
            "method": "POST",
            "body": {
                "username": "loginuser_log1",
                "password": "${TEST_PASSWORD}"
            },
            "extract_id_from": "id"
        },
    ...
    },
    {
        ...
        "endpoint": "/user/login",
        "method": "POST",
        "description": "Login with wrong password, expect 401 with 'Invalid credentials' message",
        "setup": {
            "endpoint": "/user/register",
            "method": "POST",
            "body": {
                "username": "loginuser_log2",
                "password": "${TEST_PASSWORD}"
            },
            "extract_id_from": "id"
        },
    ...
    },
    {
        ...
        "endpoint": "/user/logout",
        "method": "POST",
        "description": "Attempt to logout without providing an Authorization header, expect 401",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/user/refresh",
        "method": "POST",
        "description": "Attempt to refresh without providing an Authorization header, expect 401",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    {
        "name": "refresh_with_access_token_instead_of_refresh",
        "category": "INVALID_INPUT",
        "endpoint": "/user/refresh",
        "method": "POST",
        "description": "Attempt to refresh using an access token instead of a refresh token, expect 422 (wrong token type)",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/user/{id}",
        "method": "GET",
        "description": "Get the authenticated user's own profile by ID, expect 200 with user data",
        "setup": {
            "endpoint": "/user/register",
            "method": "POST",
            "body": {
                "username": "getuser_gu1",
                "password": "${TEST_PASSWORD}"
            },
            "extract_id_from": "id",
            "auth_from_setup": {
        ...
        "request_data": {
            ...
            "query": {},
            "headers": {
                "Authorization": "Bearer $setup_auth_token"
            },
            "body": null
        },
        "expected_status": 200,
    ...
    },
    {
        ...
        "endpoint": "/user/{id}",
        "method": "GET",
        "description": "Attempt to get a user without providing an Authorization header, expect 401",
        "setup": null,
        "request_data": {
            "path": {
                "id": 1
    ...
    },
    {
        ...
        "endpoint": "/user/{id}",
        "method": "DELETE",
        "description": "Delete the authenticated user's own account, expect 200 with 'Deleted' message",
        "setup": {
            "endpoint": "/user/register",
            "method": "POST",
            "body": {
                "username": "deluser_du1",
                "password": "${TEST_PASSWORD}"
            },
            "extract_id_from": "id",
            "auth_from_setup": {
    ...
    },
    {
        ...
        "endpoint": "/user/{id}",
        "method": "DELETE",
        "description": "Attempt to delete a user with a non-existent ID, expect 404",
        "setup": null,
        "request_data": {
            "path": {
                "id": 999999
    ...
    },
    {
        ...
        "endpoint": "/user/{id}",
        "method": "DELETE",
        "description": "Attempt to delete a user without providing an Authorization header, expect 401",
        "setup": null,
        "request_data": {
            "path": {
                "id": 1
