...
Generated at: 2026-03-03T09:38:59.178845+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    json.loads(r'''[
    {
        ...
        "method": "POST",
        "description": "Register a new user with valid username and password, expect 201 with user data",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/user/register",
        "method": "POST",
        "description": "Attempt to register with an already-existing username, expect 400",
        "setup": {
            "endpoint": "/user/register",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/user/register",
        "method": "POST",
        "description": "Attempt to register without a username field, expect 400",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/user/login",
        "method": "POST",
        "description": "Login with valid credentials, expect 200 with access_token and refresh_token",
        "setup": {
            "endpoint": "/user/register",
            "method": "POST",
            "body": {
                "username": "testuser_login1",
                "password": "${TEST_PASSWORD}"
            },
            "extract_id_from": "id"
        },
    ...
    {
        "name": "login_user_invalid_password",
        "category": "INVALID_INPUT",
        "endpoint": "/user/login",
        "method": "POST",
        "description": "Login with wrong password, expect 401 with 'Invalid credentials'",
        "setup": {
            "endpoint": "/user/register",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "method": "POST",
        "description": "Logout with a valid access token, expect 200 with 'Logged out'",
        "setup": {
            "endpoint": "/user/register",
            "method": "POST",
            "body": {
                "username": "testuser_logout1",
                "password": "${TEST_PASSWORD}"
            },
            "extract_id_from": "id"
        },
    ...
    },
    {
        ...
        "endpoint": "/user/logout",
        "method": "POST",
        "description": "Attempt to logout without an access token, expect 401",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "method": "POST",
        "description": "Refresh access token with a valid refresh token, expect 200 with new access_token",
        "setup": {
            "endpoint": "/user/register",
            "method": "POST",
            "body": {
                "username": "testuser_refresh1",
                "password": "${TEST_PASSWORD}"
            },
            "extract_id_from": "id"
        },
    ...
    },
    {
        ...
        "endpoint": "/user/{id}",
        "method": "GET",
        "description": "Create a user, login, and retrieve own user data by ID, expect 200",
        "setup": {
            "endpoint": "/user/register",
            "method": "POST",
            "body": {
                "username": "testuser_get1",
                "password": "${TEST_PASSWORD}"
            },
            "extract_id_from": "id"
        },
    ...
    },
    {
        ...
        "endpoint": "/user/{id}",
        "method": "GET",
        "description": "Attempt to get a user that does not exist, expect 404",
        "setup": {
            "endpoint": "/user/register",
            "method": "POST",
            "body": {
                "username": "testuser_get404",
                "password": "${TEST_PASSWORD}"
            },
            "extract_id_from": "id"
        },
    ...
    },
    {
        ...
        "endpoint": "/user/{id}",
        "method": "GET",
        "description": "Attempt to get a user without an access token, expect 401",
        "setup": null,
        "request_data": {
            "path": {
                "id": 1
    ...
    },
    {
        ...
        "endpoint": "/user/{id}",
        "method": "DELETE",
        "description": "Create a user, login, and delete own account, expect 200 with 'Deleted'",
        "setup": {
            "endpoint": "/user/register",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/user/{id}",
        "method": "DELETE",
        "description": "Attempt to delete a user that does not exist, expect 404",
        "setup": {
            "endpoint": "/user/register",
            "method": "POST",
            "body": {
                "username": "testuser_del404",
                "password": "${TEST_PASSWORD}"
            },
            "extract_id_from": "id"
        },
    ...
    },
    {
        ...
        "endpoint": "/user/{id}",
        "method": "DELETE",
        "description": "Attempt to delete a user without an access token, expect 401",
        "setup": null,
        "request_data": {
            "path": {
                "id": 1
