...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    ...
    },
    {
        ...
        "endpoint": "/store/",
        "method": "POST",
        "description": "Create a new store for the authenticated user with a valid name",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/store/{id}",
        "method": "GET",
        "description": "Attempt to retrieve a store with a non-existent ID, expecting 404",
        "setup": null,
        "request_data": {
            "path": {
                "id": 999999
    ...
    },
    {
        ...
        "endpoint": "/store/{id}",
        "method": "DELETE",
        "description": "Create a store, then delete it. Expects 200 with a deletion confirmation message.",
        "setup": {
            "endpoint": "/store/",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/store/{id}",
        "method": "DELETE",
        "description": "Attempt to delete a store with a non-existent ID, expecting 404",
        "setup": null,
        "request_data": {
            "path": {
                "id": 999999
    ...
    },
    {
        ...
        "endpoint": "/item/",
        "method": "POST",
        "description": "Attempt to create an item in a non-existent store, expecting 404",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/item/s",
        "method": "GET",
        "description": "List all items across all stores owned by the authenticated user. Returns an array.",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/item/{id}",
        "method": "GET",
        "description": "Attempt to retrieve an item with a non-existent ID, expecting 404",
        "setup": null,
        "request_data": {
            "path": {
                "id": 999999
    ...
    },
    {
        ...
        "endpoint": "/item/{id}",
        "method": "PUT",
        "description": "Attempt to update an item with a non-existent ID, expecting 404",
        "setup": null,
        "request_data": {
            "path": {
                "id": 999999
    ...
    },
    {
        ...
        "endpoint": "/item/{id}",
        "method": "DELETE",
        "description": "Attempt to delete an item with a non-existent ID, expecting 404",
        "setup": null,
        "request_data": {
            "path": {
                "id": 999999
