...
Generated at: 2026-03-03T09:35:45.419042+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    json.loads(r'''[
    {
        ...
        "endpoint": "/health/",
        "method": "GET",
        "description": "Verify health endpoint returns 200 with healthy status when API and database are operational",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/health/",
        "method": "GET",
        "description": "Verify health endpoint response contains both 'status' and 'database' fields with value 'healthy'",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
